...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 block bg-white border-t border-gray-200 sm:hidden pb-safe">
      <div className="flex justify-around items-center h-16">
        ...
        <Link
          href="/orders"
          className={`flex flex-col items-center justify-center w-full h-full space-y-1 ${
            isActive('/orders') ? 'text-primary-600' : 'text-gray-500'
          }`}
        >
          <svg
            className="w-6 h-6"
